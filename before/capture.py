...
def capture_center(path, tpath):
    ...
    for file in os.listdir(path):
        ...
        savepath = os.path.join(tpath, file)
        print(savepath)
...
if __name__ == '__main__':
    path = r"G:\data\study\GitHub\dataset_test\period\0617\origin"
    tpath = r"G:\data\study\GitHub\dataset_test\period\0617\enhance"
