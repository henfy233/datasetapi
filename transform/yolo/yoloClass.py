"""
@Introduce : 根据文件夹分类，同一文件夹分为一类
@File      : yoloClass.py
@Time      : 2021/7/14 10:06
@Author    : luhenghui

执行：python yoloClass.py
python yoloClass.py --root_dir ../../../dataset_test/merge/0628
...
parser.add_argument('--root_dir', type=str, default='yolo_data', help="root path of images and labels")
